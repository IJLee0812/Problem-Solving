...
int DFS_V[MAX_VERTICES] = {0, }; // DFS_VISITED
int BFS_V[MAX_VERTICES] = {0, }; // BFS_VISITED
int graph[MAX_VERTICES][MAX_VERTICES] = {0, }; 
int queue[MAX_VERTICES];

void dfs(int v, int vertices); void bfs(int v, int vertices);
